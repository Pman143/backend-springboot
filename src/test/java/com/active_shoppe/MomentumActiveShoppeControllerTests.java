...
public class MomentumActiveShoppeControllerTests {
    ...
    public void savedProductsCanBeRetrieved() {
        ...
        Assert.assertEquals(1, productDto.size());
    }
    ...
    public void validProductsCanBeRetrieved() {
        ...
        List<ProductDto> productDto = productService.getAllProducts();
        Assert.assertEquals(Integer.valueOf(20), productDto.get(0).getProductCost());
        Assert.assertEquals("Product Name", productDto.get(0).getProductName());
        Assert.assertEquals("P1", productDto.get(0).getProductCode());
    }
    ...
    public void buyProduct() {
        ...
        CustomerModel customerModel = new CustomerModel(customerId, "Prince", customerActiveDaysModel);
